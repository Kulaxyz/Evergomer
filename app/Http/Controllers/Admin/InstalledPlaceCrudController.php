...
class InstalledPlaceCrudController extends CrudController
{
    ...
    {
        $this->crud->setModel(InstalledPlace::class);
        $this->crud->setEntityNameStrings('Installed Place', 'Installed Places');
        $this->crud->setRoute(backpack_url('installed_place'));
    }
