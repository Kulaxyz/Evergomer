...
class ConnectionMethodCrudController extends CrudController
{
    ...
    {
        $this->crud->setModel(ConnectionMethod::class);
        $this->crud->setEntityNameStrings('Connection Method', 'Connection Methods');
        $this->crud->setRoute(backpack_url('connection_method'));
    }
