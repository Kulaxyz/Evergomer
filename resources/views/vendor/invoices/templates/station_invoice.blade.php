...
<html lang="en">
    ...
    <body>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-0 pl-0">
                        ...
                        <p>{{ __('invoices::invoice.payment') }}: <strong>{{ $invoice->getPaymentId() }}</strong></p>
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @if($invoice->tax_rate)
                    <tr>
                        <td colspan="{{ $invoice->table_columns - 2 }}" class="border-0"></td>
                        <td class="text-right pl-0">{{ __('invoices::invoice.tax_rate') }}
                            <br>
                            {{ 'SGST '.round($invoice->tax_rate/2,2).'% CGST '.round($invoice->tax_rate/2,2).'%'  }}</td>
                        <td class="text-right pr-0">
                            {{ $invoice->tax_rate }}%
                        </td>
                    </tr>
        ...
        @if($invoice->getPaymentStatus() == 'Due')
            <p>
